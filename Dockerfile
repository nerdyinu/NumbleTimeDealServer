...
RUN chmod 755 pinpoint-bootstrap-2.5.0.jar
EXPOSE 8000
ENV JAVA_OPTS="-javaagent:/app/pinpoint-bootstrap-2.5.0.jar -Dpinpoint.agentId=app-1 -Dpinpoint.applicationName=app"
